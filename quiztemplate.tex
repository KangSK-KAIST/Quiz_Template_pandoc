...
\newcommand{\blank}{\line(1,0){80}\,}
\newcommand{\threedots}{\(\cdots\)\,}
\newcommand{\compact}{\setstretch{1.0}}
\newcommand{\broad}{\setstretch{1.5}}
\newcommand{\spade}{\ding{171}\quad}
\newcommand{\graybox}[1]{\begin{tcolorbox} \begin{center} #1 \end {center} \end{tcolorbox}}
...
\textbf{\textsf{\Large English test}} \hspace{1.5cm}
Date: \line(1,0){120} \hspace{1.5cm}
